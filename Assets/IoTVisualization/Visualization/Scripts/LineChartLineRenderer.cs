...
{
    /// <summary>
    /// This LineRenderer requires a meshfilter and a meshrenderer. It generates the line as a mesh consisting of multiple quads.
    /// 
    /// This LineRenderer offers a much better precision than the default LineRenderer.
    /// Some disadvantes are: nor correctly faced triangles, a bit worse performance and weird behaviour 
    /// in some edge cases that are not occuring during the intended purpose.
    /// </summary>
    [RequireComponent(typeof(MeshFilter))]
    [RequireComponent(typeof(MeshRenderer))]
    public class LineChartLineRenderer : MonoBehaviour
    {
        /// <summary>
        /// Width of the line
        /// </summary>
